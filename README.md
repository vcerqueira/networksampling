...
good results that works as follows. First, it considers a node v from the network and sets a stopping criterion. 

### *** Implementation ***

While this criterion is not met, the algorithm 
